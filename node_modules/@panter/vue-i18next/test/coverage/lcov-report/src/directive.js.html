...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> directive.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable no-param-reassign, no-unused-vars */
&nbsp;
...
function equalValue(value, oldValue) {
  if (value === oldValue) {
    return true;
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (value &amp;&amp; oldValue) {
    return (
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Sep 24 2018 08:51:47 GMT+0000 (UTC)
</div>
</div>
